...
class TabNetRegressionTrainer(BaseModel):
...
class LightGBMRegressionTrainer(BaseModel):
...
class CatBoostRegressionTrainer(BaseModel):
    def __init__(self, config: DictConfig):
        super().__init__(config)
...
class XGBoostRegressionTrainer(BaseModel):
    def __init__(self, config: DictConfig):
        super().__init__(config)
...
class MlpRegressionTrainer(BaseModel):
    def __init__(self, config: DictConfig):
        super().__init__(config)
